                            ...
                            <div class="p-3 border-bottom">
                                <div class="media">
                                    <div class="align-self-center mr-3">
                                        <img src="{{asset('chat/images/users/avatar-2.jpg')}}" class="avatar-xs rounded-circle" alt="">
                                    </div>
                                        ...
                                        <ul class="list-unstyled chat-list" data-simplebar style="max-height: 345px;">
                                                ...
                                                <a href="#">
                                                    <div class="media">
                                                        ...
                                                        <div class="user-img online align-self-center mr-3">
                                                            <img src="{{asset('chat/images/users/avatar-2.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                                ...
                                                <a href="#">
                                                    <div class="media">
                                                        <div class="user-img away align-self-center mr-3">
                                                            <img src="{{asset('chat/images/users/avatar-3.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                                            <span class="user-status"></span>
                                                        </div>
                                                        <div class="media-body overflow-hidden">
                                                ...
                                                <a href="#">
                                                    <div class="media">
                                                        <div class="user-img align-self-center mr-3">
                                                            <img src="{{asset('chat/images/users/avatar-4.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                                            <span class="user-status"></span>
                                                        </div>
                                                        <div class="media-body overflow-hidden">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="media">
                                                        <div class="user-img online align-self-center mr-3">
                                                            <img src="{{asset('chat/images/users/avatar-6.jpg')}}" class="rounded-circle avatar-xs" alt="">
                                                            <span class="user-status"></span>
                                                        </div>
                                                        <div class="media-body overflow-hidden">
                                        ...
                                        <li>
                                            <div class="conversation-list">
                                                <div class="chat-avatar">
                                                    <img src="{{asset('chat/images/users/avatar-2.jpg')}}" alt="">
                                                </div>
